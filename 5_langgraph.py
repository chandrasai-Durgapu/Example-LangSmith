...
@traceable(name="final_evaluation_fn", tags=["aggregate"], metadata={"dimension": "overall"})
def final_evaluation(state: UPSCState):
    # Summarize overall feedback using prior feedbacks
    prompt = (
        "Based on the feedback below, summarize overall feedback:\n\n"
        ...
        "Also compute the average score from the individual scores."
    )
...
if __name__ == "__main__":
    result = workflow.invoke(
        ...
        config={
            ...
            "tags": ["essay", "langgraph", "evaluation", "groq"],
            "metadata": {
